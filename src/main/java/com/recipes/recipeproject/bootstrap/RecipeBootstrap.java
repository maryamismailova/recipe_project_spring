package com.recipes.recipeproject.bootstrap;

import com.recipes.recipeproject.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeBootstrap(RecipeService recipeService, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository, CategoryRepository categoryRepository) {
    ...
    private List<Recipe> getRecipes() {
        ...
        System.out.println("Read all uof and Category");
...
//        System.out.println("Tacos notes' recipe:"+tacoNotes.getRecipe());
        return recipes;
    }
}
